...
import { Zap, Smartphone, Laptop, ShoppingBag, Headphones, Home, Sparkles, ArrowRight, Grid } from 'lucide-react';
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <div style={{ background: isSelected ? 'var(--primary)' : 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(8px)', width: '36px', height: '36px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: isSelected ? '#fff' : 'var(--primary)', border: '1px solid rgba(255,255,255,0.4)' }}>
                      <IconComponent size={20} />
                    </div>

                    <span style={{ background: 'rgba(255, 255, 255, 0.25)', backdropFilter: 'blur(8px)', color: '#fff', fontSize: '0.725rem', fontWeight: 800, padding: '0.2rem 0.65rem', borderRadius: '20px' }}>
                      {cat.count} Items
                    </span>
                  </div>
                  ...
                  <div style={{ marginTop: 'auto' }}>
                    ...
                    <p style={{ color: '#E2E8F0', fontSize: '0.78rem', margin: 0, lineHeight: 1.25, height: '2.4em', overflow: 'hidden' }}>
                      {cat.description}
                    </p>
                  </div>
                </div>
